                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Here's quick access to all of the upcoming appointments until 7 days.<br>
                                        More details available in at the Appointments section.
                                    </p>

                                </td>
                                <td>
                                    <p style="text-align:leftt;padding:10px;padding-left:48px;padding-bottom:0;font-size:23px;font-weight:700;color:var(--primarycolor);">
                                    ...
                                    <p style="padding-bottom:19px;text-align:left;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                        Here is quick access to all of the upcoming sessions until 7 days.<br>
                                        More details and actions available at the Sessions section.
                                    </p>
                                </td>
                            </tr>
                            <tr>
